...
#ifndef __STREAM_SOCKET_TEST_H__INCL__
#define __STREAM_SOCKET_TEST_H__INCL__

/**
 * @brief Test of StreamSocket.
 *
 * @author Bloody.Rabbit
 */
...
public:
     ...
     */
    StreamSocketTest()
    : CppUnit::TestCase( "StreamSocketTest" )
    {
    }
...
template< typename L3 >
const typename L3::SocketAddress StreamSocketTest< L3 >::SOCKET_ADDRESS =
    L3::GetSocketAddress( L3::GetAddressByHostname( "localhost" ),
                          L3::GetPort( 43250 ) );
template< typename L3 >
const char StreamSocketTest< L3 >::MESSAGE[] =
    "This is a test message of StreamSocketTest.";

#endif /* !__STREAM_SOCKET_IP4_TEST_H__INCL__ */
