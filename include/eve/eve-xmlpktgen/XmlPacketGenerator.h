...
#ifndef __XML_PACKET_GENERATOR_H__INCL__
#define __XML_PACKET_GENERATOR_H__INCL__
...
public:
     ...
     */
    XmlPacketGenerator( const char* header = "", const char* source = "" );
    /**
...
private:
    ...
    static const char* const FILE_COMMENT;
};

#endif /* !__XML_PACKET_GENERATOR_H__INCL__ */
