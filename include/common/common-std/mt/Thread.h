...
#ifndef COMMON_MT_THREAD_TYPE
#   define COMMON_MT_THREAD_TYPE void
#endif /* !COMMON_MT_THREAD_TYPE */
...
namespace common
{
    namespace mt
    {
        ...
        protected:
             ...
             */
            Thread( COMMON_MT_THREAD_TYPE* thread );

            /// The implementing object.
            COMMON_MT_THREAD_TYPE* mThread;
        };
    }
}
