...
#ifndef __WIN__WIN_EVENT_H__INCL__
#define __WIN__WIN_EVENT_H__INCL__
...
public:
     ...
     */
    WinEvent( BOOL manualReset = FALSE, BOOL initialState = FALSE );
     ...
     *
     * @return A value returned by @c SetEvent.
     */
    BOOL Set();
    /**
     * @brief Resets the event to nonsignaled state.
     *
     * @return A value returned by @c ResetEvent.
     */
    BOOL Reset();
};

#endif /* !__WIN__WIN_EVENT_H__INCL__ */
