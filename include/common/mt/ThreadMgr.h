...
protected:
    ...
    typedef std::queue< Thread::Target* > TargetQueue;
     ...
     */
    Thread::Target* GetTarget( WorkerList::iterator& itr );
...
protected:
    ...
    /// @see ::Worker::GetTarget().
    Thread::Target* GetTarget();
