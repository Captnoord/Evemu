...
public:
    ...
    ASCENT_INLINE uint16 GetUInt16()      { return mValue ? static_cast<uint16>(strtoul(mValue,NULL,10)) : 0; }
    ASCENT_INLINE int16 GetInt16()        { return mValue ? static_cast<int16>(strtol(mValue,NULL,10)) : 0; }
    ASCENT_INLINE uint32 GetUInt32()      { return mValue ? static_cast<uint32>(strtoul(mValue,NULL,10)) : 0; }
    ASCENT_INLINE int32 GetInt32()        { return mValue ? static_cast<int32>(strtol(mValue,NULL,10)) : 0; }
    uint64 GetUInt64()
    {
        if(mValue == NULL)
            return 0;
        ...
        uint64 value;
          ...
          sscanf(mValue, I64FMTD, (unsigned long long int*)&value);
        #else
