...
void EveClientSocket::_authStateHandshake(PyObject* object)
{
    ...
    if (birthDay != (int32)EveBirthday || machoVersion != (int32)MachoNetVersion || versionNr != EveVersionNumber || buildVersion != (int32)EveBuildVersion || projectVersion != EveProjectVersion)
    {
