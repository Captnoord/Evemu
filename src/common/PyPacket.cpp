...
const char* MACHONETMSG_TYPE_str[MACHONETMSG_TYPE_MAX] = {
...
bool PyPacket::Decode(PyRep *&in_packet) {
	...
	case MACHONETMSG_TYPE_IDENTIFICATION_REQ:
	case MACHONETMSG_TYPE_IDENTIFICATION_RSP:
	case MACHONETMSG_TYPE_CALL_REQ:
	case MACHONETMSG_TYPE_CALL_RSP:
	case MACHONETMSG_TYPE_TRANSPORTCLOSED:
	case MACHONETMSG_TYPE_RESOLVE_REQ:
	case MACHONETMSG_TYPE_RESOLVE_RSP:
	case MACHONETMSG_TYPE_NOTIFICATION:
	case MACHONETMSG_TYPE_ERRORRESPONSE:
	case MACHONETMSG_TYPE_SESSIONCHANGENOTIFICATION:
	case MACHONETMSG_TYPE_SESSIONINITIALSTATENOTIFICATION:
